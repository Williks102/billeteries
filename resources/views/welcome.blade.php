        ...
        <div class="row text-center">
            <div class="col-md-3 mb-4">
                <div class="stat-item">
                    ...
                    <h3 class="stat-number">{{ $totalEvents ?? '50+' }}</h3>
            ...
            <div class="col-md-3 mb-4">
                <div class="stat-item">
                    ...
                    <h3 class="stat-number">{{ $totalTickets ?? '10K+' }}</h3>
            ...
            <div class="col-md-3 mb-4">
                <div class="stat-item">
                    ...
                    <h3 class="stat-number">{{ $totalUsers ?? '2K+' }}</h3>
